...
```{r}
# ADF test for stationarity. Null = non-stationary
adf_result_diff <- adf.test(model_ts_diff$total_calls, alternative = "stationary")
# having problems reevaluating the stationarity of the differenced series here, I am leaving this here to come back to after I finalize all the models.
adf_result_diff
```
...
SAA_original_scale <- SAA_final_forecast |>
  mutate(total_calls = .mean + last_observed)
